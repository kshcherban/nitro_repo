# Nitro Repo Helm Chart

This Helm chart deploys Nitro Repo, a universal artifact repository supporting Docker, Go, Maven, NPM, PHP, Python, and Helm packages.
...
# Install the chart
helm install my-nitro-repo ./nitro-repo-chart
```

## Uninstalling the Chart

```bash
helm uninstall my-nitro-repo
```
...
|-----------|-------------|---------|
| `replicaCount` | Number of Nitro Repo replicas | `1` |
| `image.repository` | Container image repository | `ghcr.io/sudoers/nitro-repo` |
    ...
    - host: nitro.example.com
      paths:
        - path: /
          pathType: Prefix
  tls:
    - secretName: nitro-tls
      hosts:
        - nitro.example.com
postgresql:
  auth:
    existingSecret: nitro-db-secret
```
...
```bash
helm upgrade my-nitro-repo ./nitro-repo-chart
```

## Contributing

This chart is part of the Nitro Repo project. Please submit issues and PRs to the main repository.