...
use super::{
    ResolvedVirtualMember, VirtualMemberClient, VirtualResolutionCache, VirtualResolutionOrder,
    VirtualResolver,
};
...
impl VirtualMemberClient for RecordingClient {
    async fn fetch(
        ...
        _path: &StoragePath,
        _method: Method,
    ) -> Result<Option<crate::repository::RepoResponse>, crate::repository::npm::NPMRegistryError>
    {
