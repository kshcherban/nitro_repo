...
- `GET /p2/<vendor>/<package>.json`  
  Returns Composer V2 metadata with dist URLs rewritten to Nitro Repo.
...
- `PUT /dist/<vendor>/<package>/<version>.zip`  
  ...
  Nitro Repo validates name/version against path, computes checksums, updates `/p2/...` metadata, and
  indexes the version.
