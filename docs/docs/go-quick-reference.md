...
|-------------|----------|---------|
| Version List | `GET /{module}/@v/list` | `https://your-nitro-repo.example.com/repositories/<storage>/<repo>/github.com/user/module/@v/list` |
| Version Info | `GET /{module}/@v/{version}.info` | `https://your-nitro-repo.example.com/repositories/<storage>/<repo>/github.com/user/module/@v/v1.2.3.info` |
| Go Mod File | `GET /{module}/@v/{version}.mod` | `https://your-nitro-repo.example.com/repositories/<storage>/<repo>/github.com/user/module/@v/v1.2.3.mod` |
| Module Zip | `GET /{module}/@v/{version}.zip` | `https://your-nitro-repo.example.com/repositories/<storage>/<repo>/github.com/user/module/@v/v1.2.3.zip` |
| Latest Info | `GET /{module}/@latest` | `https://your-nitro-repo.example.com/repositories/<storage>/<repo>/github.com/user/module/@latest` |
