...
# Runs all or specific integration tests for Nitro Repo
...
print_header() {
    echo ""
    print_color "$BLUE" "============================================"
    print_color "$BLUE" " Nitro Repo Integration Test Suite"
    print_color "$BLUE" "============================================"
    echo ""
}
...
Run integration tests for Nitro Repo package repositories.
